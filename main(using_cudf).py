"""
    和main.py是一样的，只是关键的几个步骤用了cudf代替pandas，目的是用GPU跑
"""
import os
import numpy as np
import pandas as pd
...
os.chdir(r"/mnt/e/OneDrive/大学/大四下/投资中的数据分析方法/小组pre/show")
...
temp3 = cudf.from_pandas(cal_df2)
temp3 = temp3.groupby('realmonth').apply(get_annual_factors_return.get_annual_factors_return)
